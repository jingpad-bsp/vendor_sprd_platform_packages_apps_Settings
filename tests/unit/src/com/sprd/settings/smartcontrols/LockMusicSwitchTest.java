...
import com.sprd.settings.smartcontrols.LockMusicSwitchPreferenceController;
...
@SmallTest
public class LockMusicSwitchTest extends SmartControlsTestBase {
    ...
    public void setUp() throws UiObjectNotFoundException {
        ...
        mIsSupport = LockMusicSwitchPreferenceController.isLockMusicSwitchAvailable(mContext) &&
        ...
        mTitle = mContext.getResources().getString(R.string.lock_music_switch);
        mItemLevel = 2;
    ...
    public void putSettingsProvider(int value) {
        Settings.Global.putInt(mContext.getContentResolver(), LOCK_MUSIC_SWITCH, value);
    }

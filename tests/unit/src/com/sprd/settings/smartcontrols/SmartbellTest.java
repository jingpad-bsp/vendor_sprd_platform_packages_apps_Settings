...
import com.sprd.settings.smartcontrols.SmartBellPreferenceController;
...
@SmallTest
public class SmartbellTest extends SmartControlsTestBase {
    ...
    public void setUp() throws UiObjectNotFoundException {
        ...
        mIsSupport = SmartBellPreferenceController.isSmartBellAvailable(mContext);
        ...
        mTitle = mContext.getResources().getString(R.string.smart_bell);
        mItemLevel = 2;
    ...
    public void putSettingsProvider(int value) {
        Settings.Global.putInt(mContext.getContentResolver(), SMART_BELL, value);
    }

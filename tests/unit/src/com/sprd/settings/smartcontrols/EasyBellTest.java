...
import com.sprd.settings.smartcontrols.EasyBellPreferenceController;
...
@SmallTest
public class EasyBellTest extends SmartControlsTestBase {
    ...
    public void setUp() throws UiObjectNotFoundException {
        ...
        mIsSupport = EasyBellPreferenceController.isEasyBellAvailable(mContext);
        ...
        mTitle = mContext.getResources().getString(R.string.easy_bell);
        mItemLevel = 2;
    ...
    public void putSettingsProvider(int value) {
        Settings.Global.putInt(mContext.getContentResolver(), EASY_BELL, value);
    }

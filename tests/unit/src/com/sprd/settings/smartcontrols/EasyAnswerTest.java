...
import com.sprd.settings.smartcontrols.EasyAnswerPreferenceController;
...
@SmallTest
public class EasyAnswerTest extends SmartControlsTestBase {
    ...
    public void setUp() throws UiObjectNotFoundException {
        ...
        mIsSupport = EasyAnswerPreferenceController.isEasyAnswerAvailable(mContext);
        ...
        mTitle = mContext.getResources().getString(R.string.easy_answer);
        mItemLevel = 2;
    ...
    public void putSettingsProvider(int value) {
        Settings.Global.putInt(mContext.getContentResolver(), EASY_ANSWER, value);
    }

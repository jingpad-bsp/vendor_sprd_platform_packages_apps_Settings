...
import com.sprd.settings.smartcontrols.EasyDialPreferenceController;
...
@SmallTest
public class EasyDialTest extends SmartControlsTestBase {
    ...
    public void setUp() throws UiObjectNotFoundException {
        ...
        mIsSupport = EasyDialPreferenceController.isEasyDialAvailable(mContext);
        ...
        mTitle = mContext.getResources().getString(R.string.easy_dial);
        mItemLevel = 2;
    ...
    public void putSettingsProvider(int value) {
        Settings.Global.putInt(mContext.getContentResolver(), EASY_DIAL, value);
    }

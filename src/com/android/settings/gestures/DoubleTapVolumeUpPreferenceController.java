...
public class DoubleTapVolumeUpPreferenceController extends GesturePreferenceController {
    ...
    private static final String KEY = "gesture_double_tap_volumeup";

    public DoubleTapVolumeUpPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public boolean setChecked(boolean isChecked) {
        return Settings.Secure.putInt(mContext.getContentResolver(), VOLUME_UP_SECURE_KEY,
                isChecked ? ON : OFF);
    }
}

...
public class SeekBarVolumizerEx extends SeekBarVolumizer {
    ...
    private static final int DELAY_THE_START_TIME = 400;
    ...
    @UnsupportedAppUsage
    public SeekBarVolumizerEx(Context context, int streamType, Uri defaultUri, Callback callback) {
        this(context, streamType, defaultUri, callback, true /* playSample */);
    }

    public SeekBarVolumizerEx (
            Context context,
            int streamType,
            Uri defaultUri,
            Callback callback,
            boolean playSample) {
        super(context,streamType,defaultUri,callback,playSample);
        mContext = context;
        ...
        mMuted = mOriginalStreamVolume == 0 ? true : mAudioManager.isStreamMute(mStreamType);
    ...
    // Bug  1156875 : override method in super class, and make it work in sub class.
    @Override
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            ...
            case MSG_INIT_SAMPLE:
                ...
                break;
            default:
                Log.e(TAG, "invalid SeekBarVolumizerEx message: "+msg.what);
        }
        return true;
    }
    ...
    private void onStartSample() {
        if (!isSamplePlaying()) {
            ...
            /*Add for bug1428033: Delay the start time @{ */
            try {
                Thread.sleep(DELAY_THE_START_TIME);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromTouch) {
        ...
        if (mCallback != null) {
            ...
            //update icon view with the Callback
            mCallback.onMuted(progress > 0 ? false : true,isZenMuted());
        }
    }
    ...
    private void postSetVolume(int progress) {
        ...
        mAudioManager.setStreamVolume(mStreamType, progress, AudioManager.FLAG_SHOW_UI_WARNINGS);
    }
    ...
    private final class H extends Handler {
        ...
        public void postUpdateSlider(int volume, int lastAudibleVolume, boolean mute) {
            /* Bug 1131729 : volume progress jumps when adjust the volume seekbar @{ */
            removeMessages(UPDATE_SLIDER);
            Message message = obtainMessage(UPDATE_SLIDER, volume, lastAudibleVolume, new Boolean(mute));
            if (!mFromTouch) {
                sendMessage(message);
            }
            /* Bug 1131729 @} */
